...
class MovieController
{
    ...
    public function getMovies($search = '', $selectedGenre = null, $selectedDistrib = null, $searchType = 'all', $limit = 20, $page = 1) {
        return $this->movieModel->searchMovies($search, $selectedGenre, $selectedDistrib, $searchType, $limit, $page);
    }
    ...
    public function getDistributors() {
        return $this->distribModel->getAllDistributors();
    }
}